...
| Reusable protocol agents | Extracted master plus reactive-target agent connected without the fabric DUT | analysis-port event checker and UVM report counts | [VIP guide](../vip/axi4/README.md) and VIP self-test summary |
